...
def test_linear_topology_4_motes(sim):
    sim = sim(**{'numMotes': 4, 'topology': 'linear'})
    motes = sim.motes
...
def test_two_branch_topology_with_6_motes(sim):
    sim = sim(**{'numMotes': 6, 'topology': 'twoBranch'})
    motes = sim.motes
...
def test_two_branch_topology_with_9_motes(sim):
    sim = sim(**{'numMotes': 9, 'topology': 'twoBranch'})
    motes = sim.motes
